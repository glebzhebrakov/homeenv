...
//        org.bytedeco.javacpp.caffe.FloatNet net = new caffe.FloatNet("test", TRAIN);

        logger.setLevel(Level.ALL);
        flags.init(new String[]{"train",""});
        GetBrewFunction("train").command();
    }
    ...
    static void CopyLayers(caffe.FloatSolver solver, String model_list) {
    ...
    static {
        ...
        RegisterBrewFunction("device_query", new BrewFunction() {
            public int command() {
                ...
                caffe.Caffe.SetDevice(caffe.Caffe.CPU);
        ...
        RegisterBrewFunction("train", new BrewFunction() {
            public int command() {
                ...
                String solverFlag = "SGD";
                String snapshot = "1 2 3";
                String weights = "";
                ...
                caffe.SolverParameter solver_param = new caffe.SolverParameter();
